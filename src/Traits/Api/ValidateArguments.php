...
namespace Samueletur\IpagLaravel\Traits\Api;
...
trait ValidateArguments
{
    ...
    private function validateGet($name, $args)
    {
        ...
        $this->mustBeArrayOrInstance($name, $args[0], \Samueletur\IpagLaravel\QueryParams::class);
    }
    ...
    private function validatePost($name, $args, $hasParameters = false)
    {
        ...
        $this->mustBeArrayOrInstance($name, $args[$hasParameters ? 1 : 0], \Samueletur\IpagLaravel\Abstracts\Model::class);
    }
    ...
    private function validatePut($name, $args)
    {
        ...
        $this->mustBeArrayOrInstance($name, $args[1], \Samueletur\IpagLaravel\Abstracts\Model::class, 1);
    }
    ...
    private function checkIfIdTypeOptionIsValid($name, $type)
    {
        ...
        $types = [\Samueletur\IpagLaravel\Abstracts\Model::MY_ID, \Samueletur\IpagLaravel\Abstracts\Model::IPAG_ID];
    ...
    private function validateRequestOptions($name, $args, $reqOpsIdx = 1)
    {
        ...
        $this->mustBeArrayOrInstance($name, $value, \Samueletur\IpagLaravel\Http\Options::class, $reqOpsIdx);
